...
- `NDF0` — InterLocusCapability / capability standing;
- `NDF1` — composition and realization;
- `NDF2` — structural/query-cut projection;
- `NDF3` — demand, service and satisfaction;
- `NDF4` — discovery, reference, resolution and binding;
- `NDF5` — forwarding/reachability specialization.

Current standing: **NDF0–NDF5 frozen; NDF6 NOT ADMITTED.**
...
- `core-theory/NETWORK-CORE-THEORY-v1.md`

Frozen semantic commit:

- `e57b3315f1724cd3d73cc66944aac8d3b9806bd6`

Durable semantic ref:
...
- `capability-calculus/NETWORK-CAPABILITY-CALCULUS-v1.md`

Frozen semantic commit:

- `fcb1ff3e1c6c191b68c09a50a10e7487f2e0eab0`
...
- `projection-currentness/NETWORK-PROJECTION-CURRENTNESS-THEORY-v1.md`

Frozen semantic commit:

- `28e6e23fd5881d37dd807983f694c2f17ec6392d`
...
- `operational-realization/NETWORK-OPERATIONAL-REALIZATION-THEORY-v1.md`

Frozen semantic commit:

- `d63c0c7e48771ca6c7acb2b5dd6ef240102c8342`

Durable semantic ref:

- `refs/ordivon/research/network-operational-realization-v1`
...
- `whole-nct/WHOLE-NCT-DERIVED-RECONCILIATION-v1.md`

Frozen semantic commit:

- `7d125e54d6eaf8f4f67b93f9e05b803ac4ccac57`

Durable semantic ref:

- `refs/ordivon/research/network-whole-nct-reconciliation-v1`

Upstream reopen-condition audit: **36 conditions audited; 0 fired** at freeze.

## 7. Canonical ancestry

The semantic lineage is linear and provenance-preserving:
